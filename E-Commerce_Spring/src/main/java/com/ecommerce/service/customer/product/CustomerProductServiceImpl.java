...
public class CustomerProductServiceImpl implements CustomerProductService {
    ...
    public CustomerProductServiceImpl(CategoryRepository categoryRepository, ProductRepository productRepository,
			FAQRepository faqRepository, ReviewRepository reviewRepository) {
		super();
